...
> Tài liệu nguồn chuẩn xác duy nhất (Single Source of Truth) về thiết chế, hạ tầng, biểu phí, lịch học và thông tin liên hệ của **Cung Văn Hóa Lao Động TP. Hồ Chí Minh — Cơ Sở Bình Trưng**.

---

## 1. Thông Tin Định Danh & Kênh Truyền Thông Chính Thức
...
## 2. Quy Mô Hạ Tầng & Cơ Sở Vật Chất
...
1. **Khối nhà chính 5 tầng kiên cố:**
   ...
   - **Lầu 2 & Lầu 3:** Hệ thống 02 hội trường hiện đại:
     ...
     - **Hội trường nhỏ (250 chỗ ngồi):** Phục vụ hội thảo, tập huấn, sinh hoạt chuyên đề.
2. **Cụm nhà thi đấu Cầu Lông trong nhà:**
   - 06 sân cầu lông đạt chuẩn thi đấu, trải thảm nhựa PVC xanh lục chống trơn trượt.
   - Hệ thống đèn LED chiếu sáng hiện đại, quầy căng tin, phòng thay đồ và khu vệ sinh tiện nghi.
3. **Khuôn viên thể thao ngoài trời & có mái che:**
   - Sân bắn cung chuyên dụng cạnh cụm cầu lông.
   - Sân tập võ thuật (Boxing, Taekwondo), sân bóng rổ và sân trượt patin.
   - Sân trước rộng rãi đỗ xe ô tô, xe máy sức chứa hàng trăm người.
   - Không gian cà phê âm nhạc thanh niên ngoài trời (Chill's Melody).
...
## 4. Bản Đồ Tài Nguyên Media Trong Repository

Mọi hình ảnh phục vụ bài viết truyền thông hoặc giao diện website được tổ chức tại thư mục `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/`:
- **Logo chính thức:** `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/logo.jpg`
- **Ảnh cơ sở mới (tòa nhà, không gian):** `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/Hinh-co-so-moi/` (1.jpg, 2.jpg, unnamed.webp)
- **Ảnh từng lớp học:**
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/ban-cung/` (5 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/bong-da/` (3 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/bong-ro/` (3 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/Boxing/` (4 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/cau-long/` (3 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/mua-dan-gian/` (4 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/nhay-hien-dai/` (4 ảnh)
  - `Cung-Van-Hoa-Lao-Dong-Co-So-Binh-Trung/LOP-HOC/Teakwondo/` (4 ảnh)
